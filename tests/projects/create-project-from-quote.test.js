...
describe("POST /api/v1/projects/from-quote/:quoteId", () => {
  it("debe crear un proyecto desde una cotización aprobada y conectarla", async () => {
    ...
    // Arquitecto asignado al proyecto
    ...
    // Quote ya aprobada por el cliente
    ...
    expect(res.body.project.title).toBe("Casa Moderna Vista Lago");
    ...
    // Verificación extra en base de datos
